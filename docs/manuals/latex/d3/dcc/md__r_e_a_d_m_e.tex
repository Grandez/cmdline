...
Dado un parametro P o \mbox{\hyperlink{struct_parameter}{Parameter}}\+:
...
\item ¿\+Por que tengo que elegir como usuario, y controlar como desarrollador, las dos opciones -\/P y --\mbox{\hyperlink{struct_parameter}{Parameter}}?
\item En el caso de que no exista una version corta del parámetro, ¿\+Por que necesito escribir \mbox{\hyperlink{struct_parameter}{Parameter}} si con la primera letra ya seria suficiente?
