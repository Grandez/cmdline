\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysection{disclaimer}\label{md__r_e_a_d_m_e_autotoc_md11}
Aqui el disclaimer\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysection{Motivacion}\label{md__r_e_a_d_m_e_autotoc_md12}
...
Ahora bien, dependiendo del sistema operativo, la forma habitual de indicar estos parámetros varía; es mas, cada programador podría definir un nuevo sistema de entrada de parámetros. Esto obliga, o al menos debería, a que un programa multiplataforma debería adecuarse a cada sistema para aceptar el estilo de cada uno de ellos.\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsection{sistemas nix}\label{md__r_e_a_d_m_e_autotoc_md13}
...
{\ttfamily command -\/h} {\ttfamily command -\/-\/help} {\ttfamily command -\/af} {\ttfamily command -\/a -\/f} {\ttfamily command -\/o output\+\_\+file}\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsection{sistemas windows}\label{md__r_e_a_d_m_e_autotoc_md14}
{\ttfamily command /h} {\ttfamily command /-\/Y} {\ttfamily command /D\+:value} {\ttfamily command /o output\+\_\+file}

y actualmente con Powershell tambien se soportan las formas \textquotesingle{}-\/\textquotesingle{} y \textquotesingle{}--\textquotesingle{} y en algunos casos combinadas con \textquotesingle{}\+:\textquotesingle{}\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysubsection{ZOS y otros}\label{md__r_e_a_d_m_e_autotoc_md15}
...
Por ejemplo {\ttfamily /pre pattern} y {\ttfamily /preffix pattern} son equivalentes en el sentido de que no existe mas que un comando que empiece por la secuencia {\ttfamily pre}\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysection{Definiciones}\label{md__r_e_a_d_m_e_autotoc_md16}
...
Y cada programa puede aceptar un determinado número de opciones, incluida ninguna, y de flags, incluidos ninguno, pero en el caso de que exista al menos uno, este, por definición debe asumir un valor por defecto cuando no es especificado en la linea de comandos.\hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysubsection{Datos de entrada}\label{md__r_e_a_d_m_e_autotoc_md17}
Es cualquier elemento o secuencia de ellos que debe ser procesado por el programa.

Por ejemplo\+: {\ttfamily cat fichero.\+txt} mostrara por pantalla el contenido del fichero fichero.\+txt\hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsection{Opciones}\label{md__r_e_a_d_m_e_autotoc_md18}
...
Por ejemplo\+: {\ttfamily grep -\/e \+\_\+pattern\+\_\+} o {\ttfamily grep -\/-\/regexp \+\_\+pattern\+\_\+} indica a grep que patrón usar\hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysubsection{Flags}\label{md__r_e_a_d_m_e_autotoc_md19}
...
Notese que estos flags son complementarios; es decir, afectan a las misma funcionalidad.\hypertarget{md__r_e_a_d_m_e_autotoc_md20}{}\doxysection{Incoherencias}\label{md__r_e_a_d_m_e_autotoc_md20}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md21}{}\doxysection{Propuesta}\label{md__r_e_a_d_m_e_autotoc_md21}
